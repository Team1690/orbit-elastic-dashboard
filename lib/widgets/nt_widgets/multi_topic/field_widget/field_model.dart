...
class FieldWidgetModel extends MultiTopicNTWidgetModel {
  ...
  FieldWidgetModel({
    ...
    String? fieldGame,
    this._robotImagePath,
    this._showOtherObjects = true,
    this._showTrajectories = true,
    this._showVisionTargets = false,
    this._showGamePieces = false,
    this._showSpecialMarkers = false,
    ...
    this._visionTargetColor = Colors.green,
    this._gamePieceColor = Colors.yellow,
    this._bestGamePieceColor = Colors.orange,
    super.period,
